### Assigned to Harsh 
1. In the chat section when I write a long message then when it goes horizontally then the previous text gets hidden. I want the functionality like whatsapp, intagram or other platform where it is a big div inside that there is a section where all the text is written and also if the text is too big then we can scroll in that section also. 
